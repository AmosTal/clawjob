              ...
              >
                <Link href="/signin">
                  <motion.span
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="inline-flex items-center gap-2.5 rounded-2xl bg-emerald-600 px-8 py-4 text-lg font-bold text-white shadow-xl shadow-emerald-500/25 ring-1 ring-emerald-500/30 transition-all hover:bg-emerald-500 hover:shadow-emerald-500/30 touch-manipulation min-h-[52px]"
                  >
                    Get Started Free
            ...
            <div className="mt-8">
              <Link href="/signin">
                <motion.span
                  whileHover={{ scale: 1.04 }}
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-2.5 rounded-2xl bg-emerald-600 px-9 py-4 text-lg font-bold text-white shadow-xl shadow-emerald-500/25 ring-1 ring-emerald-500/30 transition-all hover:bg-emerald-500 hover:shadow-emerald-500/30 touch-manipulation min-h-[52px]"
                >
                  Create Free Account
                  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
