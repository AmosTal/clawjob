...
export default function AdminSidebar() {
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span className={active ? "text-emerald-500" : "text-zinc-500"}>
                {item.icon}
              </span>
              {item.label}
            </Link>
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex lg:flex-col lg:w-60 lg:fixed lg:inset-y-0 bg-zinc-900 border-r border-zinc-800">
        {sidebarContent}
      </aside>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-50 w-60 bg-zinc-900 border-r border-zinc-800 flex flex-col lg:hidden"
            >
              <button
                onClick={() => setMobileOpen(false)}
